...
const card = ({ projectName, description, language1, language2 ,image}) => {
    return (
        <div id="app" class="h-60 rounded-lg shadow-lg flex transform transition duration-600 hover:scale-105 bg-white mx-10  bg-opacity-40 backdrop-filter backdrop-blur-lg  ">
